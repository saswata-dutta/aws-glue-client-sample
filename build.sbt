organization := "org.saswata"

name := "aws-glue-client"

scalaVersion := "2.12.8"

// https://mvnrepository.com/artifact/com.amazonaws/aws-java-sdk-glue
libraryDependencies += "com.amazonaws" % "aws-java-sdk-glue" % "1.11.543"
...
val host = "artifactory.saswata.com"
...
publishTo := {
  ...
  Some(realm at s"http://$host/artifactory/$suffix")
}

def envVar(key: String): String = scala.sys.env.getOrElse(key, "")

credentials += Credentials(realm, host, envVar("ARTIFACTORY_USER"), envVar("ARTIFACTORY_PASS"))
